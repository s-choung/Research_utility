...
#SBATCH --job-name=slabgen_eval
#SBATCH --time=96:00:00
#SBATCH -o slurm_logs/slabgen_eval.%N.%j.out
#SBATCH -e slurm_logs/slabgen_eval.%N.%j.err
#SBATCH --gres=gpu:1

# Slab Generation & Energy Evaluation Script
# Generates all Miller indices (max=1) with all terminations and evaluates energies using UMA
...
echo "=========================================="
echo "SLAB GENERATION & EVALUATION JOB"
