...
# Define failed calculations: (trajectory_file, termination_index)
failed_calculations = [
    # Chunk 2 failures
    {
        'file': './slabs/CeO2_100_4x4_relaxed.traj',
    ...
    {
        'file': './slabs/TiO2_rutile_101_5x4_relaxed.traj',
        'termination': 0,  # First of 2 terminations
    ...
    # Chunk 4 failures
    {
        'file': './slabs/ZnO_001_6x6_relaxed.traj',
    ...
    {
        'file': './slabs/SiO2_101_5x5_relaxed.traj',
        'termination': 0,  # First of 4 terminations
        'material': 'SiO2',
        'miller': '(1,0,1)',
        'chunk': 5
    },
